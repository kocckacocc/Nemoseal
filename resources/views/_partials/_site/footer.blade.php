<footer class="mt-auto bg-neutral">
  <div class="flex flex-col px-4 py-8 mx-auto lg:space-x-4 lg:flex-row max-w-screen-2xl sm:px-6 lg:items-center lg:justify-between lg:px-8">
    ...
    <div class="flex justify-center order-3 w-full mt-6 lg:order-1 lg:justify-start lg:mt-0">
      <p class="text-base text-left text-white">
        &copy; Minden jog fenntartva © NÉMO Seal Kft.
      </p>
    </div>
    ...
    <div class="flex justify-center w-full space-x-6 lg:order-3 lg:justify-end">
      ...
      @foreach($data['all_pages'] as $page)

        <a href="/oldal/{{ $page['slug'] }}" class="text-base text-white hover:underline">
          {{ $page['menu_item'] }}
        </a>
