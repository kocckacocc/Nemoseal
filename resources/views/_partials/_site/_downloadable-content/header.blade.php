<header class="page-header">
  ...
  <div class="relative px-4 py-24 pb-12 mx-auto pt-28 max-w-screen-2xl md:pt-40 md:pb-14 sm:px-6 lg:px-8">
    <h1 class="page-header__title">Letölthető dokumentumok</h1>
  </div>
</header>
