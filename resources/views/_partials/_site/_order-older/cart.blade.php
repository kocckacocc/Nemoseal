                ...
                <div class="sm:rounded-lg">
                    ...
                    <div class="flow-root">
                        <dl class="text-sm divide-y divide-neutral divide-opacity-10">
                            ...
                            <div class="flex items-center justify-between px-6 py-4 hidden // transport_cost_wrap">
                                <dt class="opacity-75">
                                    Szállítási költség
                                </dt>
                                <dd class="font-medium">
                            ...
                            <div class="flex items-center justify-between px-6 py-4 // transport_free_wrap">
                                <dt class="opacity-75">
                                    Ingeyenes szállítás
                                </dt>
                            </div>
