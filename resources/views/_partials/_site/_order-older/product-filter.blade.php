<div class="relative hidden w-full col-span-3 space-y-6" x-data="{ open: false }">
...
<aside class="relative w-full col-span-3 space-y-6">
	<form class="bg-white divide-y divide-neutral divide-opacity-20">
