...
<form method="post" class="relative flex flex-col w-full overflow-hidden bg-white">
				...
				@foreach ($data['user']['addresses'] as $address_id => $address)
					...
					<div class="flex items-center pb-2 cursor-pointer">
						...
						<div class="flex items-center pr-4">
							<input class="w-4 h-4 border-transparent border-opacity-25 rounded-full border-neutral text-secondary focus:ring-2 focus:ring-secondary // address_radio" type="radio" id="shipping_address_{{ $address['id'] }}"
				...
				<div class="py-2 // address_chooser">
					...
					@foreach ($data['user']['addresses'] as $address_id => $address)
						...
						<div class="flex items-center pb-2 cursor-pointer">
							...
							<div class="flex items-center pr-4">
								<input class="w-4 h-4 border-transparent border-opacity-25 rounded-full border-neutral text-secondary focus:ring-2 focus:ring-secondary // address_radio" type="radio" id="payment_address_{{ $address['id'] }}"
