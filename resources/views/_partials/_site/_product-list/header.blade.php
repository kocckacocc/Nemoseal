  ...
  <div class="relative px-4 py-24 pb-12 mx-auto space-y-4 pt-28 max-w-screen-2xl md:pt-40 md:pb-14 sm:px-6 lg:px-8">
    ...
    <nav class="flex" aria-label="Breadcrumb">
      <ol role="list" class="flex items-center space-x-4">
        ...
        <li>
          <div class="flex items-center">
            <svg class="flex-shrink-0 w-5 h-5 text-white opacity-50" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
              <path d="M5.555 17.776l8-16 .894.448-8 16-.894-.448z"></path>
            </svg>
            <a href="/kategoriak/{{ $data['manufacturer_slugs'][$data['request']['manufacturer_id']] }}" class="ml-4 text-sm font-medium text-white opacity-50 hover:opacity-100 hover:text-secondary-light">{{ $data['manufacturer']['name'] }}</a>
          </div>
        </li>
    ...
    <h1 class="truncate page-header__title">
