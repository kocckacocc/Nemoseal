        ...
        <div class="flex items-center">
          ...
          <div>
            ...
            <dl class="flex flex-col mt-6 sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
              <dt class="sr-only">Mélyépítő Kft.</dt>
...
<div class="mt-8">
  ...
  <h2 class="px-4 mx-auto mt-8 text-lg font-medium leading-6 text-gray-900 sm:px-6 lg:px-8">
    Aktuális
  </h2>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr class="bg-white">
                <td class="w-full px-6 py-4 text-sm text-gray-900 max-w-0 whitespace-nowrap">
                  <div class="flex">
                    <a href="#" class="inline-flex space-x-2 text-sm truncate group">
                      <!-- Heroicon name: solid/cash -->
                      <svg class="flex-shrink-0 w-4 h-4 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" clip-rule="evenodd" />
                      </svg>
                      <p class="text-gray-500 truncate group-hover:text-gray-900">
                        Rendelés leadás Partner Neve
                      </p>
                    </a>
                  </div>
                </td>
                ...
                <td class="px-6 py-4 text-sm text-right text-gray-500 whitespace-nowrap">
                  <time datetime="2020-07-11">2021.12.01</time>
                </td>
              </tr>
          ...
          <nav class="flex items-center justify-between px-4 py-3 bg-white border-t border-gray-200 sm:px-6" aria-label="Pagination">
            <div class="hidden sm:block">
              <p class="text-sm text-gray-700">
                <span class="font-medium">1</span>-<span class="font-medium">10</span>
                a(z)
                <span class="font-medium">20</span>
                rendelésből
              </p>
            </div>
            <div class="flex justify-between flex-1 space-x-3 sm:justify-end">
              <a href="#" class="btn">
                Vissza
              </a>
              <a href="#" class="btn">
