  ...
  <div class="fixed inset-0 z-40 flex">
    ...
    <div class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-indigo-700">
      ...
      <div class="absolute right-0 p-1 top-1 -mr-14">
        <button type="button" class="flex items-center justify-center w-12 h-12 rounded-full focus:outline-none focus:ring-2 focus:ring-white">
      ...
      <div class="flex-1 h-0 px-2 mt-5 overflow-y-auto">
        <nav class="flex flex-col h-full">
          <div class="space-y-1">
            ...
            <a href="#" class="flex items-center px-3 py-2 text-sm font-medium text-indigo-100 rounded-md hover:bg-indigo-800 hover:text-white group">
              <!--
                    Heroicon name: outline/home

                    Current: "text-white", Default: "text-indigo-300 group-hover:text-white"
                  -->
              <svg class="w-6 h-6 mr-3 text-indigo-300 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <a href="#" class="flex items-center px-3 py-2 text-sm font-medium text-white bg-indigo-800 rounded-md group" aria-current="page">
