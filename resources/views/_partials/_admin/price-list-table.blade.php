...
<div class="w-full px-4 mx-auto sm:px-6 md:px-8">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td class="px-6 py-4 space-x-4 text-sm font-medium text-right whitespace-nowrap">
                  ...
                  <a href="/admin-price-list-details" class="text-indigo-600 hover:text-indigo-900">Szerkesztés</a>
                </td>
              </tr>
              <tr>
                <td class="px-6 py-4 whitespace-nowrap">
  ...
  <div class="pt-5">
    <div class="flex justify-end">
      <a href="/admin-price-list-details" type="button" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        Új hozzáadása
      </a>
    </div>
  </div>
