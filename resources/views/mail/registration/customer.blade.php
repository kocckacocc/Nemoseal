    ...
    <td class="container" align="" bgcolor="#FFFFFF">
      ...
      <div class="content" style="padding: 48px 32px">
        <table>
          <tr>
            <td>
              <h1 class="collapse"><strong>Sikeres regisztráció!</strong></h1>

              <h4 style="margin-top: 32px; margin-bottom: 32px">
                Tisztelt {{ $data['request']['last-name'] . ' ' . $data['request']['first-name'] }}!
              </h4>
              <p class="lead" style="margin-top: 32px;">Örömmel értesítjük hogy sikeresen regisztrált rendszerünkben,<br/>
                továbbá a felhasználói fiókja használatba vételéhez még az adminisztrátoroknak<br/>
                engedélyeznie kell a regisztrációt, ennek megtörténtéről e-mail-ben értesítjük!</p>
              <p class="lead" style="margin-top: 32px;">Köszönettel!</p>
