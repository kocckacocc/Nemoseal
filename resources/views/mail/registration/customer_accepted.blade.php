        ...
        <table bgcolor="#ffffff">
          <tr>
            <td class="logo" align="center">
              <img src="{{ url('/') }}/images/nemoseal-logo-alt.svg"/>
            </td>
          </tr>
        </table>
      </div>
    ...
    <td class="container" align="" bgcolor="#FFFFFF">
      ...
      <div class="content" style="padding: 48px 32px">
        <table>
          <tr>
            <td>
              <h1 class="collapse"><strong>Regisztráció jóváhagyva!</strong></h1>

              <h4 style="margin-top: 32px; margin-bottom: 32px">
                Tisztelt {{ $data['request']['last-name'] . ' ' . $data['request']['first-name'] }}!
              </h4>
              <p class="lead" style="margin-top: 32px;">Örömmel értesítjük hogy az adminisztráció jóváhagyta regisztrációját!</p>
