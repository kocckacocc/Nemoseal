...
<head>
  ...
  <!-- <link
rel="stylesheet" type="text/css" href="{{ $data['root_url'] }}catalog/view/css/font-gilroy.css"/> -->
    ...
    <td class="container" align="" bgcolor="#FFFFFF">
      ...
      <div class="content" style="padding: 48px 32px">
        <table>
          <tr>
            <td>
              <h1 class="collapse"><strong>Köszönjük megrendelését!</strong></h1>
              ...
              <p class="lead" style="margin-top: 32px;">Az alábbi táblázatban láthatja a megrendelt termékeket.</p>
                  ...
                  <tr class="product">
                    <td>
                      <p class="lead">
                        ...
                        <br/>
                        {{ $product['quantity'] }} × {{ number_format($product['price'], 0, ',', '.') }} {{ $data['data']['currency'] }}
                      </p>
                    </td>
                    <td></td>
                  </tr>
